...
namespace Vostok.System.Metrics.Windows.Native.Structures
{
    ...
    {
        [FieldOffset(0)] public PdhStatus CStatus;
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct PdhCounter
    {
        public readonly IntPtr Handle;
    }
    
    internal class PdhQuery : SafeHandleZeroOrMinusOneIsInvalid
    {
        private PdhQuery() : base(true)
        {
        }

        protected override bool ReleaseHandle()
            => Pdh.PdhCloseQuery(handle) == PdhStatus.PDH_CSTATUS_VALID_DATA;
